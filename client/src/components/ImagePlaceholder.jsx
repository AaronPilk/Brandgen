export default function ImagePlaceholder({ label }) {
  return (
    <div className="w-full aspect-square rounded-xl border-2 border-dashed border-brand-purple/40 bg-brand-purple/5 flex flex-col items-center justify-center gap-2 p-4">
      ...
      <p className="text-xs text-brand-purple/70 text-center font-medium">
        Image Preview
      </p>
