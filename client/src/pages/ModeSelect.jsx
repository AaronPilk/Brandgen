  ...
  return (
    ...
    >
      ...
      <motion.div variants={item}>
        <div className="glossy-badge inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8">
      ...
      {/* Mode Cards */}
      <motion.div variants={item} className="grid md:grid-cols-2 gap-5 w-full max-w-3xl mb-8">
        {/* ECOM Card */}
        <motion.button
          ...
          className={`relative text-left p-7 rounded-3xl transition-all duration-300 ${
            selected === 'brand' ? 'glossy-selected' : 'glossy hover:shadow-elevated-lg'
          }`}
        >
          {selected === 'brand' && (
            <div className="absolute top-4 right-4 w-6 h-6 bg-brand-purple rounded-full flex items-center justify-center shadow-lg shadow-brand-purple/30">
          ...
          <div className="relative z-10">
            <div className="w-11 h-11 rounded-xl bg-surface-raised/80 flex items-center justify-center mb-4 backdrop-blur-sm border border-surface-border">
              <ShoppingBag className="w-5 h-5 text-content-secondary" />
            </div>
            <div className="text-[11px] font-bold text-brand-purple uppercase tracking-widest mb-1.5">ECOM</div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={f} className="flex items-start gap-2.5 text-[12px] text-content-secondary">
                  <span className="text-brand-purple mt-px">•</span> {f}
                </li>
              ))}
            </ul>
          </div>
        ...
        <motion.button
          ...
          className={`relative text-left p-7 rounded-3xl transition-all duration-300 ${
            selected === 'lead' ? 'glossy-selected' : 'glossy hover:shadow-elevated-lg'
          }`}
        >
          {selected === 'lead' && (
            <div className="absolute top-4 right-4 w-6 h-6 bg-brand-purple rounded-full flex items-center justify-center shadow-lg shadow-brand-purple/30">
          ...
          <div className="relative z-10">
            ...
            <div className="text-[11px] font-bold text-brand-purple uppercase tracking-widest mb-1.5">LEAD GEN</div>
      ...
      <motion.div variants={item} className="flex flex-col items-center mb-16">
        <motion.button
          ...
          className={`px-10 py-4 rounded-2xl text-white font-semibold text-[15px] flex items-center gap-2 transition-all duration-300 ${
            selected ? 'glossy-btn' : 'glossy-btn-disabled text-content-muted cursor-not-allowed'
          }`}
        >
